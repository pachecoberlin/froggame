...
class FakeFrogDataRepository @Inject constructor() : FrogDataRepository {
    override val frogDatas: Flow<List<String>> = flowOf(fakeFrogDatas)
...
val fakeFrogDatas = listOf("One", "Two", "Three")
